...
tablePopulator.populateTable("Aguardando Segunda Aprovação", fieldsToShow, buttonsTypes);

const reloader = new Reloader();
reloader.reloadTableLoop("Aguardando Segunda Aprovação", fieldsToShow, buttonsTypes);
