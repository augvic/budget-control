...
export class EventListener {
    ...
    constructor(reloader) {
        ...
        this.aguardandoSegundaAprovaçãoButton = document.getElementById("visualizar_propostas_pendentes_segunda_aprovação");
    ...
    aguardandoSegundaAprovaçãoListener() {
        this.aguardandoSegundaAprovaçãoButton.addEventListener("click", () => {
            this.reloader.stopReloadTableLoop();
            this.reloader.stopReloadBalanceLoop();
            document.getElementById("active_module").classList.add("fade-out-left");
            document.getElementById("active_module").addEventListener("animationend", () => {
                document.getElementById("active_module").classList.remove("fade-out-left");
                this.moduleLoader.loadModule("proposals/second_approval_pending", "fade-in-right");
            }, { once: true });
        });
    }
